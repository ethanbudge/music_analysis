// =============================================================================
// model_timeline_v3.stan — Reparameterized line-level LMC *dynamics* → popularity.
//
...
//
// mean_lmc keeps a genre-varying, orientation-moderated slope; the trajectory
// shape features (slope/curve/change/sd) enter as fixed coefficients. Data
// contract matches model_timeline.stan PLUS `orientation_known`.
// =============================================================================
